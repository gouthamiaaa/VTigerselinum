...
public class CreateNewOrgWithNewContact {
	...
	driver.findElement(By.name("accountname")).sendKeys(orgName);
		...
		String phonesave=driver.findElement(By.xpath("//span[@class='dvHeaderText']")).getText();
		
		
		
		 if(phonesave.contains("Organization Information"))
				 
				 System.out.println(" new org created succesfully");
		 else
